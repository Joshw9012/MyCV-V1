  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        I am a passionate programmer driven by a desire to build innovative
        software solutions. Proficient in industry-relevant languages, I have a
        strong aptitude for problem-solving and am committed to staying updated
        with the latest industry trends and technologies. With a strong
        background in finance and accounting and effective stakeholder
        communication skills, I am recognized for creating impactful technology
        solutions.
      </p>
